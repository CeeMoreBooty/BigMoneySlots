...
/// NOTE: Renamed from BackendClient to avoid conflicting with the static
///       BackendClient helper in Scripts/Backend/BackendClient.cs.
/// </summary>
public class BackendAPIClient : MonoBehaviour
{
    ...
    public IEnumerator SubmitScore(Action<bool> onComplete = null)
    {
        ...
        if (!success) Debug.LogWarning($"[BackendAPIClient] SubmitScore failed: {req.error}");
